...
import MainnetBlindBoxAbi from "../abi/MainnetBlindBox.json";
import RinkebyBlindBoxAbi from "../abi/RinkebyBlindBox.json";

const CHAIN_ID = process.env.NEXT_PUBLIC_CHAIN_ID;
const NETWORK = CHAIN_ID === "1" ? "mainnet" : "rinkeby";
const contractABI = CHAIN_ID === "1" ? MainnetBlindBoxAbi : RinkebyBlindBoxAbi;
...
function ConnectWallet(props) {
  ...
  return (
    <div style={{ position: "relative" }}>
      <Chip
        className="text-base bg-neutral-700 text-white"
